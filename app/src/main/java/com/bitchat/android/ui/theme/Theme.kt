...
private val DarkColorScheme = darkColorScheme(
    primary = Color(0xFF1A2B96),        // Bright green (terminal-like)
    onPrimary = Color.Black,
    secondary = Color(0xFF1772B9),      // Darker green
    onSecondary = Color.Black,
    background = Color.Black,
    onBackground = Color(0xFFAFAFAF),   // Green on black
...
private val LightColorScheme = lightColorScheme(
    primary = Color(0xFF1F92EE),        // Dark green
    onPrimary = Color.White,
    secondary = Color(0xFF09365B),      // Even darker green
